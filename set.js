...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "PRINCE-MDX~AllstBypV81ddq8zynuk", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "255759112010", // Only 1 owner Number Here, others Add to sudo numbers...
